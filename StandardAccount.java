        ...
        extends Account         //Super Class
{
    ...
    private ArrayList<StoreObject> cart=new ArrayList<StoreObject>();
    private ArrayList<StoreObject> history=new ArrayList<StoreObject>();
    ...
    public StandardAccount(String sFirstName, String sLastName, char cMiddleInitial,
            String sGender, String sPassword, String sEmail,
            String sPayAccount)
    {
    ...
    public String getPayPal(int iPermissions)
    {
        if(iPermissions>0)
        {
